<?php
/**
 * Stripped-down header for the Configurator (no top nav) page template.
 *
 * Outputs the <head> section and everything up to the opening <body> content,
 * but replaces the standard top navigation with a "Back to the main site" button.
 *
 * @package cb-hydronix
 */
