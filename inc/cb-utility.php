...
/**
 * File: cb-utility.php
 * Description: A collection of utility functions and shortcodes for the WordPress theme.
 *
 * @package cb-generic
 */
...
<div class="social-share border-top border-bottom py-2 my-4">
    ...
    <a target='_blank'
        href='<?= esc_url( 'http://www.facebook.com/sharer.php?u=' . $url ); ?>'
